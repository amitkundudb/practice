...
shuffled_df = df.repartition(5)
num_partitions = shuffled_df.rdd.getNumPartitions()
print("Number of partitions after repartition:", num_partitions)

#Coalesce to shuffle data
shuffled_df = df.coalesce(2)
num_partitions = shuffled_df.rdd.getNumPartitions()
print("Number of partitions after colaesce:", num_partitions)
shuffled_df.show()